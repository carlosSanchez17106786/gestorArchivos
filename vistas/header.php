	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../librerias/fontA/css/all.css" />
	        ...
	        <div class="container">
	            ...
	            <div class="collapse navbar-collapse" id="navbarResponsive">
	                <ul class="navbar-nav ml-auto">
	                    ...
	                    <li class="nav-item">
	                        <a class="nav-link" href="../procesos/usuarios/salir"><span class="fas fa-power-off"></span> Salir</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
